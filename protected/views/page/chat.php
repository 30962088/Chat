...
<<<<<<< HEAD
                        ...
                        <div class="chatflash-fd">
                            <div class="chatflash-ctrl">
                                <div class="inblock slider-wrap">
                                    <span class="icon-sprite icon-mvol" data-init="{value:100,type:'vol',active:false}"></span>
                                    <div class="flash-slider"></div>
                                </div>
                                <span class="icon-sprite icon-camera-b" data-init="{type:'camera',active:false}"></span>
                                <div class="inblock slider-wrap">
                                    <span class="icon-sprite icon-mmic" data-init="{value:100,type:'mic',active:false}"></span>
                                    <div class="flash-slider"></div>
                                </div>
                                <div class="inblock slider-wrap">
                                    <span class="icon-sprite icon-mmusic" data-init="{value:50,type:'music',active:false}"></span>
                                    <div class="flash-slider"></div>
                                </div>
                                <span class="icon-sprite icon-close-b" data-init="{type:'close',active:false}"></span>
                            </div>
                            <script>
                                $(function(){
                                    flashCtrl({
        ...
        <fieldset class="fieldset-box">
            <div class="field-row">
                <div class="field-ui">
                    ...
                    <input type="password" name="password" data-rule='[{name:"required",message:"请填写密码"},{name:"password",message:"限制长度9-100个字符"}]' class="text">
            ...
            <div class="field-row">
                <div class="field-ui">
                    ...
                    <input type="text" name="valinum" data-rule='[{name:"required",message:"请填写验证码"},{name:"valinum",message:"限制长度1~10个字符"}]' class="text" maxlength="100">
                </div>
            </div>
            <div class="field-row" align="center">
                <img src="/images/valinum.jpg" class="valinum"/>
            </div>
...
<div class="musicpop-box common-pop-box" id="musicpop-box" style="display: none;">
    ...
    <div class="musiclist-wrap">
        <div class="musicitem" data-music="http://a134mp3.changba.com/userdata/userwork/97/18572097.mp3">
            <span class="status"> </span>
            <label class="name">老鼠爱大米(经典温柔女生版)</label>
            <a class="icon-sprite icon-close" href="javascript:void(0)"></a>
        </div>
        <?php for($i = 1;$i<=10;$i++){ ?>
        <div class="musicitem" data-music="http://a122mp3.changba.com/userdata/userwork/922/22371922.mp3">
            <span class="status"> </span>
            <label class="name">老鼠爱大米(经典温柔女生版)</label>
            <a class="icon-sprite icon-close" href="javascript:void(0)"></a>
        </div>
    ...
    <div class="music-control">
        <div class="seekBar-wrap">
            <font class="current">01:11</font>
            <div class="seekBar">
                <div class="seek">
                    <div class="playBar">
                        <span class="icon-sprite icon-mctrl"></span>
                    </div>
                </div>

            </div>
            <font class="total">04:50</font>
        </div>
        <div class="operation-wrap">
            <div class="status inblock">
                <div class="icon-sprite icon-mplay" style="display: none;"></div>
                <div class="icon-sprite icon-mpause"></div>
            </div>
            <div class="icon-sprite icon-madd inblock"></div>
        </div>
    </div>
</div>
<script></script>
